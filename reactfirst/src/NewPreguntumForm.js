...
function PreguntumForm() {
  ...
  const handleSubmit = (event) => {
    ...
    console.log('Hola')
    const { pregunta, respuesta_1, respuesta_2, respuesta_3, respuesta_4, respuesta_correcta, tema } = this.state;
    const requestOptions = {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ pregunta, respuesta_1, respuesta_2, respuesta_3, respuesta_4, respuesta_correcta, tema })
    };
    fetch('/api/v1/preguntas/create', requestOptions)
